...
#### Removed
- 5 unused Next.js template SVGs (`public/file.svg`, `globe.svg`, `next.svg`, `vercel.svg`, `window.svg`)
- Root `DEPLOYMENT.md` (duplicate of `docs/DEPLOYMENT.md`)
- `AGENTS.md` (autogenerated HeroUI index, already embedded in `CLAUDE.md`)
...
- +3 new E2E tests (67 → 70): Base64 batch encoding, Regex Humanizer flavor selector, DTO-Matic Java language selector
