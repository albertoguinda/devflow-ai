# TODO — DevFlow AI v4.15.5

> Last updated: 2026-03-07
> Context: Project finalized. 4 exhaustive audits completed (79 fixes). 1481 tests, 45 files, 1317 i18n keys (430 orphaned purged), 0 vulnerabilities.
...
- [x] Deleted 5 unused Next.js template SVGs (`public/file.svg`, `globe.svg`, `next.svg`, `vercel.svg`, `window.svg`)
- [x] Deleted root `DEPLOYMENT.md` (duplicate of `docs/DEPLOYMENT.md`)
- [x] Deleted `AGENTS.md` (autogenerated HeroUI index, already in CLAUDE.md)
- [x] Deleted `docs/slides.md` (untracked old file)
- [x] Removed empty `scripts/` directory
...
- [x] Identified 430 orphaned keys from refactored UIs across all tools
- [x] Removed from both EN and ES locales (1747 → 1317 keys, full parity)
- [x] Verified: lint 0 errors, type-check 0 errors, 1481 tests passing

### Performance Fix
- [x] Variable Name Wizard — `TYPE_OPTIONS` wrapped in `useMemo` (consistency with `LANGUAGES`)
