...
const COMMIT_STRINGS = {
  ...
  fr: {
    typeDescriptions: {
      ...
      docs: "Documentation",
      style: "Mise en forme, aucun changement de logique",
      refactor: "Refactorisation du code",
      perf: "Amélioration des performances",
      test: "Tests nouveaux ou corrigés",
      chore: "Tâches de maintenance",
      ci: "Modifications CI/CD",
      build: "Système de build ou dépendances",
      revert: "Annuler le commit précédent",
    } as Record<CommitType, string>,
    validation: {
      emptyMessage: "Le message est vide",
      invalidHeader: "L'en-tête ne suit pas le format : type(scope): description",
      headerTooLong: (len: number) => `L'en-tête comporte ${len} caractères (max 72)`,
      emptyDescription: "La description est vide",
      blankSecondLine: "La deuxième ligne doit être vide (séparateur entre en-tête et corps)",
      noUppercase: "La description ne doit pas commencer par une majuscule",
      noTrailingDot: "La description ne doit pas se terminer par un point",
    },
  },
  pt: {
    typeDescriptions: {
    ...
    validation: {
      emptyMessage: "A mensagem está vazia",
      invalidHeader: "O cabeçalho não segue o formato: type(scope): description",
      headerTooLong: (len: number) => `O cabeçalho tem ${len} caracteres (máx 72)`,
      emptyDescription: "A descrição está vazia",
      blankSecondLine: "A segunda linha deve estar vazia (separador entre cabeçalho e corpo)",
      noUppercase: "A descrição não deve começar com maiúscula",
      noTrailingDot: "A descrição não deve terminar com ponto",
    },
  },
  de: {
    typeDescriptions: {
    ...
    validation: {
      ...
      invalidHeader: "Der Header entspricht nicht dem Format: type(scope): description",
      headerTooLong: (len: number) => `Der Header hat ${len} Zeichen (max. 72)`,
      emptyDescription: "Die Beschreibung ist leer",
      blankSecondLine: "Die zweite Zeile muss leer sein (Trennzeichen zwischen Header und Body)",
      noUppercase: "Die Beschreibung sollte nicht mit einem Großbuchstaben beginnen",
      noTrailingDot: "Die Beschreibung sollte nicht mit einem Punkt enden",
    },
  },
  it: {
    typeDescriptions: {
      ...
      docs: "Documentazione",
      style: "Formattazione, nessuna modifica alla logica",
      refactor: "Refactoring del codice",
      perf: "Miglioramento delle prestazioni",
      test: "Test nuovi o corretti",
      chore: "Attività di manutenzione",
      ci: "Modifiche CI/CD",
      build: "Sistema di build o dipendenze",
      revert: "Annullare il commit precedente",
    } as Record<CommitType, string>,
    validation: {
      emptyMessage: "Il messaggio è vuoto",
      invalidHeader: "L'intestazione non segue il formato: type(scope): description",
      headerTooLong: (len: number) => `L'intestazione ha ${len} caratteri (max 72)`,
      emptyDescription: "La descrizione è vuota",
      blankSecondLine: "La seconda riga deve essere vuota (separatore tra intestazione e corpo)",
      noUppercase: "La descrizione non deve iniziare con una maiuscola",
      noTrailingDot: "La descrizione non deve terminare con un punto",
    },
  },
  zh: {
    typeDescriptions: {
    ...
    validation: {
      emptyMessage: "消息为空",
      invalidHeader: "标题不符合格式：type(scope): description",
      headerTooLong: (len: number) => `标题共 ${len} 个字符（最多 72 个）`,
      emptyDescription: "描述为空",
      blankSecondLine: "第二行必须为空（标题与正文之间的分隔行）",
      noUppercase: "描述不应以大写字母开头",
      noTrailingDot: "描述不应以句号结尾",
    },
  },
  ja: {
    typeDescriptions: {
    ...
    validation: {
      ...
      invalidHeader: "ヘッダーが形式に従っていません: type(scope): description",
      headerTooLong: (len: number) => `ヘッダーは ${len} 文字です（最大 72 文字）`,
      emptyDescription: "説明が空です",
      blankSecondLine: "2行目は空でなければなりません（ヘッダーと本文の区切り）",
      noUppercase: "説明は大文字で始めるべきではありません",
      noTrailingDot: "説明はピリオドで終わるべきではありません",
    },
  },
} as const;
