...
[![Tests](https://img.shields.io/badge/tests-1446_passing-brightgreen?style=flat-square&logo=vitest&logoColor=white)](https://github.com/albertoguinda/devflow-ai)
...
```bash
npm run test:run                                             # All unit tests (1446)
